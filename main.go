...
func main() {
	...
	secret := flag.String("secret", "", "Key to encrypt via HMAC. Part of experimental appengine support.")
	export := flag.String("export", "", "If filled, try to export to this server. Part of experimental appengine support.")
	...
	if *fake {
		...
		log.Fatal("Must supply -serial, -can_addr, or -fake. See https://github.com/CalSol/teleserver for details")
	}
